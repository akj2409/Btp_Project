...
const Jobcard = ({ id,title, skillset, amount , deleteFunc}: any) => {
  ...
  return (
    <div className=" flex w-4/5 justify-between relative z-0 flex-row gap-4 m-4 p-4 rounded-[10px] bg-foreground hover:shadow-[0px_7px_30px_0px_rgba(90,114,123,0.11)] l:flex-col l:w-4/5 xm:w-4/5 ">
